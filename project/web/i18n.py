...
ALGORITHM_OPTIONS = ("", "round-robin", "min-load", "greedy", "max-min", "carbon-aware")
SCENARIO_OPTIONS = (
    "",
    "static",
    "dynamic-load",
...
MODE_LABELS: dict[str, dict[str, str]] = {
    ...
    "ru": {
        ...
        "carbon-study": "Углеродное исследование",
...
UI_TEXT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "agent_control_link": "Agent Control / Quality Gate",
        ...
        "carbon_outcomes_title": "Carbon Study Outcomes",
        "carbon_outcomes_pending": "Carbon outcomes are not available yet.",
        "carbon_best_method": "Best CO2 method",
        "carbon_baseline_method": "Baseline method",
        "carbon_co2_per_task": "CO2 per task",
        "carbon_co2_total": "CO2 total",
        ...
        "claims_title": "Evidence-backed Claims",
        "claims_pending": "Claims are not available yet.",
        "claims_gate_failed": "Claims quality gate did not pass.",
        "claims_hypothesis_filter": "Hypothesis",
        "claims_min_confidence": "Min confidence",
        "claims_with_evidence_only": "with evidence only",
        "claims_all_hypotheses": "All",
        "claims_no_matches": "No claims match the current filters.",
    ...
    "ru": {
        ...
        "agent_control_link": "Управляемость агента / Quality Gate",
        ...
        "carbon_outcomes_title": "Итоги углеродного исследования",
        "carbon_outcomes_pending": "Итоги по CO2 пока недоступны.",
        "carbon_best_method": "Лучший метод по CO2",
        "carbon_baseline_method": "Базовый метод",
        "carbon_co2_per_task": "CO2 на задачу",
        "carbon_co2_total": "Суммарный CO2",
        ...
        "claims_title": "Проверяемые выводы",
        "claims_pending": "Выводы пока недоступны.",
        "claims_gate_failed": "Контроль качества выводов не пройден.",
        "claims_hypothesis_filter": "Гипотеза",
        "claims_min_confidence": "Мин. уверенность",
        "claims_with_evidence_only": "только с источниками",
        "claims_all_hypotheses": "Все",
        "claims_no_matches": "Нет выводов под текущие фильтры.",
